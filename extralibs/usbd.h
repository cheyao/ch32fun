...
#define USBFS_EP_MODE_TX "Are you sure you want to use USB FS?"
#define USBFS_EP_MODE_RX "Are you sure you want to use USB FS?"
...
struct _USBState
{
	...
	uint8_t ep0buf[USBD_PACKET_SIZE];

#define CTRL0BUFF (USBDCTX.ep0buf)
};
